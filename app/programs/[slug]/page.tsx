...
function getProgram(slug: string) {
  ...
  const programs: Record<string, any> = {
    ...
    'self-discovery': {
      ...
      format: '오프라인',
      theme: '자기계발',
      keywords: ['자기이해', '명상', '상담', '내면성장', '정서회복'],
      points: [
        '동서양 철학·심리·명상 관점을 통한 깊이 있는 자기 이해',
        '수사학적 글쓰기와 공감적 대화를 통한 감정 정리',
        '명상 실습을 통한 내면의 목소리 듣기',
        '현실적인 실행 계획 수립 및 지속 가능한 변화 기반 마련',
      ],
      bookingSteps: [
        {
          step: 1,
          title: '예약 및 문의',
          description: '참여 인원과 일정을 확인하고 프로그램 예약을 진행합니다. 기타 문의사항이나 요청사항을 함께 작성해주세요.',
        },
        {
          step: 2,
          title: '견적서 및 안내',
          description: '프로그램 예약 시 견적서, 결제 방법, 강사 프로필을 전달받을 수 있습니다.',
        },
        {
          step: 3,
          title: '프로그램 진행',
          description: '진행 3~5일 전 강사 연락처 및 프로그램 리마인드 안내가 발송됩니다.',
        },
      ],
      notes: [
        '명상이나 철학 공부 경험이 없어도 참여 가능합니다.',
        '개인적인 이야기 나눔은 전적으로 선택 사항입니다.',
        '한 번 참여로도 충분한 효과를 얻을 수 있으며, 연속 과정도 가능합니다.',
        '준비물은 워크시트와 필기구만 있으면 됩니다.',
      ],
      curriculum: [

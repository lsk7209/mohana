    ...
    <section className="py-16 md:py-24 bg-neutral-gray dark:bg-black/20 rounded-lg">
      <div className="flex flex-col gap-10 px-4 py-10 @container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-0">
          <div className="flex flex-col flex-1 gap-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-background-dark p-6 items-center text-center">
            <span className="material-symbols-outlined text-primary text-4xl">verified_user</span>
            <div className="flex flex-col gap-1">
              <h3 className="text-dark-slate-gray dark:text-white text-base font-bold leading-tight">검증된 강사진</h3>
          ...
          <div className="flex flex-col flex-1 gap-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-background-dark p-6 items-center text-center">
            ...
            <div className="flex flex-col gap-1">
              <h3 className="text-dark-slate-gray dark:text-white text-base font-bold leading-tight">맞춤형 프로그램</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-normal leading-normal">
                기업의 목표와 상황에 최적화된 프로그램을 설계합니다.
              </p>
            </div>
          </div>
          <div className="flex flex-col flex-1 gap-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-background-dark p-6 items-center text-center">
            ...
            <div className="flex flex-col gap-1">
              <h3 className="text-dark-slate-gray dark:text-white text-base font-bold leading-tight">지속적인 후속 컨설팅</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-normal leading-normal">
                일회성으로 끝나지 않는 지속적인 성장을 지원합니다.
              </p>
            </div>
          </div>
        </div>

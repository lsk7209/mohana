...
export function AdminSidebar() {
  ...
  return (
    <aside className="flex h-screen min-h-full flex-col justify-between bg-white dark:bg-gray-900 p-4 w-64 sticky top-0 border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="flex flex-col gap-1">
        <Link
          href="/admin/settings"
          className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-dark-gray-text dark:text-gray-300"
        >
          <span className="material-symbols-outlined">settings</span>
          <p className="text-sm font-medium leading-normal">설정</p>
        </Link>
        <button className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-dark-gray-text dark:text-gray-300">
